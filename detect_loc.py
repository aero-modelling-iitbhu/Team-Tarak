...
class GridSurveyNode:
    ...
    def detection_loop(self):
        """
        Runs YOLO detection on video stream (Updated Logic with Live Drone GPS).
        """
        # ===================== PATHS =====================
        ...
        logging.info("🚀 Human detection started (GPS logging with live MAVLink data)...")
        ...
        try:
            ...
            while not self.stop_requested and cap.isOpened():
                ...
                # Get current drone GPS (Live MAVLink Data)
                drone_lat = 0.0
                drone_lon = 0.0
                drone_alt = 0.0
