...
class GridSurveyNode(Node):
    ...
    def __init__(self):
        ...
        #make_change
        self.alt_ref = None                # reference altitude (AGL)
    ...
    def get_current_global_position(self, timeout=1.0):
        ...
        while time.time() - start < timeout:
            ...
            try:
                ...
                #made_change
                alt_abs = msg.alt / 1000.0  # mm -> m
                if self.alt_ref is None:
                    self.alt_ref = alt_abs
                alt_rel = alt_abs - self.alt_ref  # AGL
    ...
    def load_and_run_mission(self):
        ...
        # made_change
        self.alt_ref = None  # reset alt ref before takeoff
